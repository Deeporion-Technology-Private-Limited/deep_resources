            ...
            <Box className="w-full h-full px-10 ">
              ...
              >
                ...
                <label
                  ...
                  className={`w-full h-64 text-center relative rounded-lg ${
              ...
              <Box className="flex gap-2 flex-wrap">
                {labelsArray?.map((label) => (
                  <DefaultButton
                    key={label?.id}
                    className={cn(
                      "rounded-lg w-fit border capitalize bg-[##E8EBED] text-[##26282B]",
                      {
                        "bg-[#EBE3E0] border-[#BFA59A] text-zinc-800":
                ...
                <Box className="flex gap-5 items-center w-full p-1 flex-wrap">
                  {categories?.map((label) => (
                    <DefaultButton
                      key={label?.id}
                      className={cn(
                        "rounded-3xl w-fit capitalize bg-[#E8EBED] text-[#72787F]",
                        {
