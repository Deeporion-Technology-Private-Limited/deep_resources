      ...
      <div className={cn(accordionStyle({ variant, className }))}>
        <div
          ...
          <div className="flex items-center justify-between w-full">
            ...
            <div
              className={`duration-300 transform rotate-180 cursor-pointer hover:shadow hover:border  ${handleButton && "origin-center rotate-[none] "} `}
              onClick={handleClick}
              data-testid="icon">
              {Icon}
            </div>
        ...
        {handleButton && (
          <div
            className={cn(
              ` w-full ${handleButton ? "h-auto " : "h-0"}  left-0 border  bg-white`,
              childClassName
            )}>
