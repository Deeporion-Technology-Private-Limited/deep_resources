...
const slideStyles = cva(["w-[100vw]", "flex-shrink-0", "text-center"], {
  variants: {
    variant: {
...
type SlideProps = ComponentProps<"div"> &
  VariantProps<typeof slideStyles> & {
    items: Array<{ id: number; name: string; logoUrl?: string }>;
    variant?: SlideVariant;
  };

export const AutoCarousel = React.forwardRef<HTMLDivElement, SlideProps>(
