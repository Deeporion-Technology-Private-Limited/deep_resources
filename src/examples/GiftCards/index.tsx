import { Box, DefaultButton, FavouriteCard } from "@/components";
import { ComponentProps, forwardRef, useState } from "react";
import { ButtonIconPosition,ICards, ILabels  } from "@/components/types";
        ...
        return (
            <Box ref={ref} className={cn("flex flex-col gap-8 px-8", className)} {...props}>
                ...
                <Box className="flex justify-end">
                    <DefaultButton onClick={addNew} className="w-fit h-10" iconUrl={addCircleOutline}>
                        Add New
                    </DefaultButton>
                </Box>
            </Box>
