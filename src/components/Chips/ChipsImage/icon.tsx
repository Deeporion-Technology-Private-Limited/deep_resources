...
export const CloseBlack : React.FC<ChipsProps> = ({className , handleClicked} )=>{
    return (<div className={className} onClick={handleClicked}  >
...
export const CloseBlue : React.FC<ChipsProps> = ({className , handleClicked })=>{
    return( <div className={className} onClick={handleClicked} >
...
export const CloseWhite : React.FC<ChipsProps> = ({className , handleClicked })=>{
    return( <div className={className} onClick={handleClicked}>
   <svg xmlns="http://www.w3.org/2000/svg" width="15" height="20" viewBox="0 0 16 16" fill="none">
