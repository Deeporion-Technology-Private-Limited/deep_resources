...
import { FavouriteCard } from "../Cards";
import { Chart } from "../Charts";
import { Headings } from "../Headings";
import { GreenArrow } from "../Icons";
import { Input } from "../Input";
import { AdminProps, Box } from "../Layout";
import { Table } from "../Table/Table";
import { Text } from "../Text";
import { ChartsType, InputType, InputVariant } from "../types";
import image from "./image_luxgo cities-03 3.png";

const DashboardAdmin: React.FC<AdminProps> = ({
  UsersData,
  TableData,
  PendingData,
  DayOption,
  ...
  return (
    <div className="w-full p-4">
      ...
      <div className="flex gap-4 items-center mb-4">
        ...
        <select
          name="Days"
          className="w-[68px] p-2 text-sm cursor-pointer outline-none rounded-2xl bg-[#EBE3E0]"
        >
