...
export const FollowPage = () => {
  const [demo,setData] = useState([
    {name:"first", imgSrc:img01},{name:"second",imgSrc:img01},{name:"third",imgSrc:img01},{name:"fourth",imgSrc:img01}
  ])
  ...
  return (
    <Box>
        ...
        <Box className="flex flex-wrap justify-center mt-2">
            {demo && demo.map((values,index)=>{
                return (
                    <Box className="mx-1" key={index}>  
                    <img src={values.imgSrc} height={500} width={300}   />
                    <img onClick={()=>IconClick(values)} src={UrlIcon} style={{position:"relative",float:"inline-end",marginTop:"-300px",marginRight:"20px"}} />
