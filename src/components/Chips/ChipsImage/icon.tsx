...
export const CloseBlack: React.FC<ChipsProps> = ({ handleClicked }) => {
  return (
    <div onClick={handleClicked} data-testid="CloseBlack">
      <svg
...
// CloseBlue icon is not used
export const CloseBlue: React.FC<ChipsProps> = ({ handleClicked }) => {
  return (
    <div onClick={handleClicked} data-testid="CloseBlue">
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="15"
        height="20"
      ...
      >
        <path
          d="M12.6667 4.27333L11.7267 3.33333L8.00001 7.06L4.27334 3.33333L3.33334 4.27333L7.06001 8L3.33334 11.7267L4.27334 12.6667L8.00001 8.94L11.7267 12.6667L12.6667 11.7267L8.94001 8L12.6667 4.27333Z"
          fill="#334EAC"
        />
      </svg>
    </div>
...
export const CloseWhite: React.FC<ChipsProps> = ({ handleClicked }) => {
  return (
    <div onClick={handleClicked} data-testid="CloseWhite">
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="15"
        height="20"
