      ...
      if (!isLogin) {
        ...
        return (
          <>
            ...
            <Box
              className={`group-hover:block w-full ${
                largeSidebar ? "block" : "hidden"
              }`}
            >
        ...
        >
          <MenuItem
            ...
            className={`p-[10px_12px] ${
              item.menuLeftIcon && "p-0"
            } border-l-[4px]  border-transparent hover:border-[#3F271E] bg-transparent justify-between ${
              showSubMenuNavItem.some((val) => val.menus === item.menus)
                ? "bg-[#E8EBED] border-[#3F271E]"
                : ""
            } active:bg-[#E8EBED] shadow-none w-full rounded-none`}
        ...
        <Box
          className={`w-full flex justify-between gap-16 flex-col h-full 
            group-hover:items-start  ${
              largeSidebar ? "items-start px-[0px]" : "items-center px-[10px]"
            }`}
        >
          <Box
