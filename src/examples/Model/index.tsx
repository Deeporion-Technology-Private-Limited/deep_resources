import { Box, DefaultButton, Headings, PopupModal, ProductCard } from "@/components";
    ...
    <Box className="border border-pink-800">
      ...
      >
        ...
        <Box className="flex w-full py-4 justify-center items-center gap-2 mb-4">
          ...
          <DefaultButton className="flex-1 bg-gray-200 py-3 rounded-lg text-gray-700 font-semibold text-base font-poppins flex justify-center items-center gap-2">
