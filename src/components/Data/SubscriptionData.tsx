  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (
      ...
      if (editItemId !== null) {
        setPlans((prev) =>
          prev.map((plan) =>
            plan.id === editItemId ? { ...initialState, id: editItemId } : plan
          )
        );
        setEditItemId(null);
      } else {
                  ...
                  <div className="flex flex-col md:flex-row gap-3">
                    ...
                    <div className="flex flex-col w-full">
                      ...
                      <input
                        ...
                        name="Service"
                        placeholder="25"
                        className="border rounded p-1 outline-none [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none 
...
export const SubsData= [
  {
    ...
    PlanName: "Entry",
    Description:
      "Get access to 10GB of remote data storage and enjoy the convenience of organizing and synchronizing your files ",
    Service: "10",
    Frequency: "1 month",
    Amount: "12",
  },
