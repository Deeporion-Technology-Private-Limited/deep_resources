import { Box, DefaultButton, Input, SingleIconButton, Stack, Text } from "@/components";
              ...
              <Box className="flex flex-col gap-6">
                ...
                <Box className="flex flex-col gap-[0.94rem]">
                  <Box className="flex items-center justify-center border rounded-lg border-[#72787F]">
                    <SingleIconButton iconUrl={google} className="w-fit" />
                    <Text
                  ...
                  <Box className="flex items-center justify-center border rounded-lg border-[#72787F]">
                    <SingleIconButton iconUrl={phone} className="w-fit" />
                    <Text
