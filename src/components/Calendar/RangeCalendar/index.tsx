...
const DateRangeCalendar: React.FC<CalendarProps> = ({ year, month, onDateRangeSelect }) => {
  ...
  const renderDays = () => {
    ...
    for (let i = 1; i <= daysInMonth; i++) {
      ...
      const isSelected = isDateInRange(i) || (startDate && startDate.getDate() === i && startDate.getMonth() === currentMonth && startDate.getFullYear() === currentYear && !endDate);
