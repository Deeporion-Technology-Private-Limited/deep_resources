import { DefaultButton, Input, SingleIconButton } from "@/components";
    ...
    <div className="flex flex-col gap-5">
      <div className="border rounded-lg p-5 font-sans flex flex-col gap-5 w-full">
        ...
        <div className="flex w-full h-14 p-4 justify-center items-center gap-2 flex-grow">
          ...
          <DefaultButton className="flex-1 bg-gray-200 py-2 rounded-lg text-gray-700 font-semibold text-base font-poppins flex justify-center items-center gap-2">
            <img
              src={like}
              alt="Like"
      ...
      <div className="border rounded-lg p-5 w-full font-sans flex items-center justify-between">
        ...
        <p className="text-[#3F271E] font-medium">
          <SingleIconButton>{product.Change}</SingleIconButton>
        </p>
      </div>
